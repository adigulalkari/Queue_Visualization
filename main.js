    ...
    codeFormater: function () {
      ...
      codeTxt.forEach(function (item, index) {
        ...
        line.forEach(function (item, index) {
          ...
          if (space != null) {
            space = "&nbsp;".repeat(
              parseInt(item.slice(1, space[0].length - 1))
            );
  ...
  function gotoLine(line, duration, callback = null, skip = false) {
    setTimeout(function () {
      ...
      if (line != 0) {
        ...
        if (
          rowDiv - codeDiv + 13 > editorDiv.scrollTop &&
                ...
                gotoLine(21, 2000, function () {
                  ...
                  if (globalThis.rear < globalThis.size - 1) {
                    ...
                    if (globalThis.front != -1) {
                      document
                        .querySelector(".array-pointer .pointer.front")
                        .classList.add("move_01");
                    }
                    setTimeout(function () {
                  ...
                  if (globalThis.front < 0) {
                    ...
                    document.querySelector(
                      ".memory .front .vvalue > span"
                    ).textContent = "0";
                  }

                  gotoLine(22, 1000, function () {
                    document
                      .querySelector(".memory .queue")
                      .classList.remove("free");
                    document
                      .querySelector(".memory .queue")
                      .classList.add("used");
                    ...
                    document
                      .querySelector(".array-pointer .symbol .rear")
                  ...
                  gotoLine(25, 4000, function () {
                    console.log(
                      document.querySelector(".memory .data").parentNode
                    );
    ...
    deQueue: function (_this, e) {
      ...
      if (this.front == -1) {
        ...
        gotoLine(32, 6000, function () {
          document
            .querySelector(".pointer.front .symbol > i")
            .classList.add("active");
          setTimeout(function () {
            document
              .querySelector(".pointer.front .symbol > i")
          ...
          document
            .querySelector(".array-graphical .byte")
          ...
          gotoLine(35, 3000, function () {
            document.querySelector(".memory .i .vvalue > span").textContent =
              "0";
          ...
          gotoLine(36, 4000, function () {
            if (globalThis.rear != 0) {
              let moveBox_symbol =
                document.querySelectorAll(".move-box .symbol");
              let timecount = 1000;
              for (let x = 0; x <= globalThis.rear - 1; x++) {
                ...
                gotoLine(38, timecount, function () {
                  ...
                  let bytes = document.querySelectorAll(
                    ".array-graphical .byte"
                  );
              ...
              gotoLine(46, timecount, function () {
                ...
                document
                  .querySelector(".array-pointer .rear")
                  .classList.remove("move_" + (globalThis.rear + 1));
                globalThis.rear -= 1;
                document.querySelector(
                  ".memory .rear .vvalue > span"
                ).textContent = globalThis.rear;
              });
              timecount += 1000;
              ...
              gotoLine(42, 6000, function () {
                document
                  .querySelector(".array-pointer .front")
                  .classList.remove("move_01");
                document
                  .querySelectorAll(".index-no .number")[0]
                  .classList.add("active");
                document
                  .querySelectorAll(".index-no .number")[1]
                  .classList.remove("active");
                document.querySelector(
                  ".memory .front .vvalue > span"
                ).textContent = "-1";
  ...
  function startMain(_this, e) {
    if (_this.classList.contains("active")) {
      ...
      setTimeout(function () {
        ...
        document
          .querySelector(".array-pointer .front")
          .setAttribute("class", "pointer front");
        document
          .querySelector(".array-pointer .rear")
          .setAttribute("class", "pointer rear");
      ...
      getCommand.addEventListener("keypress", function (e) {
        if (
          ...
          if (e != undefined && event.keyCode == 13) {
            ...
            document
              .querySelector(".memory .array_size")
              .classList.remove("free");
            document.querySelector(".memory .array_size").classList.add("used");
            document.querySelector(
              ".memory .array_size .vvalue > span"
            ).textContent = queue.size;
            this.parentNode.removeChild(this);
            gotoLine(6, 0, function () {
              ...
              for (let x = 0; x < queue.size; x++) {
                ...
                document
                  .querySelector(".array-box .queue .array-graphical")
                  .appendChild(div);
              }
              let indexNo = document.querySelector(".array-box .index-no");
              indexNo.style.width = queue.size * 60 + 60 + "px";
              document.querySelector(".array-pointer").style.width =
                queue.size * 60 + 60 + "px";
              for (let x = -1; x < queue.size; x++) {
                let div = document.createElement("div");
              ...
              document
                .querySelector(".direction-box .queue-line")
                .classList.toggle("animate");

              setTimeout(function () {
                document
                  .querySelector(".array-box")
                  .classList.toggle("animate");
              }, 500);
            });
            gotoLine(7, 1000);
  ...
  function askme(questionNo) {
    ...
    switch (questionNo) {
      ...
      case 2:
        ...
        option_[0].childNodes[0].textContent =
      ...
      case 5:
        question.textContent =
          "Q. What is drawback of Linear Queue implementation using array?";
        option_[0].childNodes[0].textContent =
          "We can not use full space available.";
        option_[1].childNodes[0].textContent =
          "Time complexity is O(n) for deQueue operation.";
